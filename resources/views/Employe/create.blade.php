    ...
    <section class="section">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form class="row g-3 needs-validation" novalidate action="{{ url('addemployee') }}"
                            ...
                            <div class="row col-12 gap">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="firstname" class="form-control" id="firstname"
                                        placeholder="Enter First Name" maxlength="20" pattern="[A-Za-z ]+" required>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 ">
                                    <div class="form-group">
                                        <label class="control-label">Permanent Address<span
                                                class="text-danger">*</span></label>
                                        <textarea rows="4" class="form-control mt-2" placeholder="Enter Permanent Address"
                                            name="permanent_address"
                                            maxlength="191" id="paddress" required></textarea>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" class="form-control mt-2" placeholder="Enter Current Address" name="current_address"
                                            maxlength="191" id="caddress" required>{{ old('current_address') }}</textarea>
                            ...
                            <div class="row col-md-12 gap">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <textarea rows="4" class="form-control mt-2" placeholder="Enter Emergency Contact Address"
                                        name="emergency_contact_address" maxlength="191" id="ecaddress" required></textarea>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const fields = {
            ...
            grossSalary: document.getElementById('gross_sallery'),
